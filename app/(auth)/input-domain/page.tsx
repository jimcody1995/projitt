...
export default function InputDomain() {
  ...
  return (
    <>
      ...
      <div className="mt-[60px] flex flex-col items-center w-full relative z-[3]">
        <img src="/images/logo.png" alt="logo" className="h-[52px]" />
        <div className="w-[482px] border border-[#e9e9e9] rounded-[16px] bg-white pt-[48px] px-[38px] mt-[90px]">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="block w-full space-y-5">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input placeholder="Company Domain" {...field} className="h-[48px]" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
