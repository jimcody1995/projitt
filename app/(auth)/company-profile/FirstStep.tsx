...
export default function FirstStep({ step, setStep }: FirstStepProps) {
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div>
                      <label
                        htmlFor="logo-upload"
                        className="flex flex-col items-center justify-center sm:w-[261px] w-[100%] h-[84px] bg-[#d9efef] rounded-[12px] cursor-pointer transition hover:bg-[#c7e7e7] border-2 border-transparent hover:border-[#0d978b]"
                      >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter phone number" className="h-[48px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter website URL" className="h-[48px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
