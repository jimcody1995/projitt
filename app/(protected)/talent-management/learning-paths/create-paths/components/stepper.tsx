...
const steps = [
  { title: "Basic Info", description: "Enter Job Details" },
  { title: "Course Selection", description: "Add courses" },
  { title: "Eligibility", description: "Select who can access this course" },
          ...
          return (
            ...
            >
              ...
              {index !== steps.length - 1 && (
                <div
                  className={`absolute top-[38px] left-[18px] h-[35px] border-l border-dashed ${index < currentStep ? "border-[#0D978B]" : "border-[#626262]"
                    } z-0`}
              ...
              >
                ...
                <div
                  className="text-[11px]/[12px] text-[#a5a5a5] mt-[3px]"
