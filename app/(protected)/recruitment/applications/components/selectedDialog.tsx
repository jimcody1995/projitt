'use client'
import { Ban, Loader2, MessageSquare, Star, Trash, Upload } from "lucide-react";
...
export const SelectedDialog = ({
    ...
    return (
        ...
        >
            <div
                className="bg-[#053834] px-[20px] py-[12px] sm:w-[806px] w-full rounded-[12px] flex sm:flex-row flex-col sm:justify-between items-center"
