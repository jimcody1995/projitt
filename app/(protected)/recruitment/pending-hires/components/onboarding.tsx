...
export default function Onboarding({ setOnboarding }: { setOnboarding: any }) {
    ...
    return (
        <div data-testid="onboarding-container" id="onboarding-container">
            <div className='flex gap-[16px] items-center'>
                <button
                    className='w-[24px] h-[24px] rounded-full border border-[#e9e9e9] flex items-center justify-center cursor-pointer'
            ...
            <div className="mt-[22px] w-full rounded-[20px] bg-[#fff] border border-[#e9e9e9] py-[40px] pl-[48px] pr-[77px]">
                <div className="flex justify-between" data-testid="applicant-info-header" id="applicant-info-header">
                    <div data-testid="applicant-details">
                        <p className="font-semibold text-[20px]/[30px] text-[#8f8f8f]">
                            <span className="text-[#1C1C1C]" data-testid="applicant-name" id="applicant-name">Alice Fernadez</span> ~ Senior Data Analyst
                        </p>
                        <div className="flex gap-[15px] mt-[6px]">
                            <span
                                className='text-[14px]/[22px] px-[8px] flex items-center gap-[2px] text-[#4b4b4b]'
                                data-testid="applicant-department"
                            ...
                            <span
                                className='text-[14px]/[22px] px-[8px] flex items-center gap-[2px] text-[#4b4b4b]'
                                data-testid="applicant-employment-type"
                                id="applicant-employment-type"
                            >
                    ...
                    <Button
                        className="w-[208px] h-[42px] "
                        data-testid="send-onboarding-invite-button"
                        id="send-onboarding-invite-button"
                    >
                        Send Onboarding Invite
                    </Button>
                </div>
                <div className="mt-[40px] flex flex-col gap-[32px] w-[623px]">
                    <div data-testid="email-address-section">
                        <p className="text-[14px]/[16px] text-[#1C1C1C]" data-testid="email-address-label" id="email-address-label">Email address</p>
                        ...
                        <Input
                            type="email"
                            value="alicefernadez@Zaid LLC.com"
                            className="h-[48px]"
                    ...
                    <div data-testid="manager-section">
                        <p className="text-[14px]/[16px] text-[#1C1C1C]" data-testid="manager-label" id="manager-label">Manager</p>
                    ...
                    <div data-testid="add-to-team-section">
                        <p className="text-[14px]/[16px] text-[#1C1C1C]" data-testid="add-to-team-label" id="add-to-team-label">Add to Team</p>
                        <div className="relative">
                            <Search className="size-[18px] text-muted-foreground absolute start-3 top-1/2 -translate-y-1/2" />
                            <Input
                                placeholder=""
                                className="ps-9 w-full h-[48px]"
                                data-testid="add-to-team-input"
                                id="add-to-team-input"
                            />
                        </div>
                    </div>
