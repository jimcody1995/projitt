    ...
    return (
        <div>
            <Sheet open={open} onOpenChange={onOpenChange}>
                <SheetContent close={false} className="p-0 sm:w-[667px] sm:max-w-none bg-[#f7f7f7] gap-[0px]" data-testid="offer-letter-sheet" id="offer-letter-sheet">
            ...
            <Dialog open={preview} onOpenChange={setPreview}>
                <DialogContent close={false} className="!w-[830px] max-w-[830px]" data-testid="preview-dialog" id="preview-dialog">
                    <DialogTitle></DialogTitle>
                    <div>
