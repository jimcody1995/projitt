/**
 * Sick Leave Stepper component displaying a vertical progress tracker.
...
const steps = [
    { title: "Basic Leave Info", },
    { title: "Allowance & Accrual", },
    { title: "Eligibility", },
 ...
 * @returns JSX.Element
 */
export default function SickLeaveStepper({ currentStep }: { currentStep: number }): JSX.Element {
    return (
