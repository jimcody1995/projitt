...
/**
 * @description
 * This component, `EditMessage`, is a dialog box for editing a message. 
 ...
 */
export default function EditMessage({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex-1 flex justify-center">
                            <p className="text-[14px]/[22px]">
                                Communications/<span className="text-[#0d978b]" data-testid="template-name">Send Message (12 Recipients)</span>
                            </p>
                        </div>
