...
export default function Communication() {
    ...
    return (
        <div className="py-4 px-4 sm:px-6 bg-[#F8F9FA] min-h-screen">
            {/* Header */}
            <div className="mb-7">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full min-w-[600px]">
                        <thead className="bg-[#EEF3F2] h-[50px] sm:h-[60px]">
                            <tr>
                                <th className="px-[12px] sm:px-[16px] text-left text-[12px]/[18px] sm:text-[14px]/[22px] py-[12px] sm:py-[19px] text-[#8C8E8E]">
                                    Name
                                </th>
                                <th className="px-[12px] sm:px-[16px] text-left text-[12px]/[18px] sm:text-[14px]/[22px] py-[12px] sm:py-[19px] text-[#8C8E8E]">
                                    Message
