            ...
            <div>
                <div className="flex w-full sm:flex-row flex-col gap-[20px] justify-between items-center px-[8px] py-[6px]">
                    <div className="flex flex-col gap-[4px]">
                        <p className="text-[12px]/[20px] text-[#A5A5A5]"><span className="cursor-pointer " onClick={() => router.push('/employees/manage-employees')}>Employeee</span> <span className="text-[#0d978b]">/ Add New Employee</span></p>
