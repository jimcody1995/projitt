...
export default function OrgChartComponent() {
    ...
    return <div className="w-full h-full flex flex-col">
        ...
        <p className="text-[12px]/[20px] text-[#A5A5A5]"><span className="cursor-pointer " onClick={() => router.push('/employees/manage-employees')}>People</span> <span className="text-[#0d978b]">/ Organization Chart</span></p>
