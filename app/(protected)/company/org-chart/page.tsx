...
export default function OrgChartComponent() {
    ...
    return <div className="w-full h-full flex flex-col">
        ...
        <p className="text-[12px]/[20px] text-[#A5A5A5]"><span className="cursor-pointer " onClick={() => router.push('/company')}>Company</span> <span className="text-[#0d978b]">/ Organization Chart</span></p>
